...
from Shapeify_menu import MyMenu
...
class Shapes:
    ...
    def shapes_menu(self):
        ...
        shape_menu = MyMenu(self.canvas, shapes_menu_name_list, shapes_menue_function_list, "Button-3", is_canvas=False, shape_tag=self.tag)
